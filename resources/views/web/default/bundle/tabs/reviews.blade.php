    ...
    <div class="course-reviews-box row align-items-center">
        ...
        <div class="col-9">
            <div class="d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">{{ trans('product.content_quality') }} ({{ $bundle->reviews->count() > 0 ? round($bundle->reviews->avg('content_quality'), 1) : 0 }})</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">{{ trans('product.instructor_skills') }} ({{ $bundle->reviews->count() > 0 ? round($bundle->reviews->avg('instructor_skills'), 1) : 0 }})</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">{{ trans('product.purchase_worth') }} ({{ $bundle->reviews->count() > 0 ? round($bundle->reviews->avg('purchase_worth'), 1) : 0 }})</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">{{ trans('product.support_quality') }} ({{ $bundle->reviews->count() > 0 ? round($bundle->reviews->avg('support_quality'), 1) : 0 }})</span>
            </div>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="btn-group dropdown table-actions">
                                ...
                                <div class="dropdown-menu">
                                    <a href="/bundles/reviews/store-reply-comment" class="webinar-actions d-block text-hover-primary reply-comment">{{ trans('panel.reply') }}</a>

                                    @if(!empty($user) and $user->id == $review->creator_id)
                                        <a href="/bundles/reviews/{{ $review->id }}/delete" class="webinar-actions d-block mt-10 text-hover-primary">{{ trans('public.delete') }}</a>
                                    @endif
                                </div>
                            </div>
                        </div>
