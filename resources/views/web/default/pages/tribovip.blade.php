            ...
            <div class="row align-items-center">
                <div class="col-lg-6 ">
                    <div class="default-title">
                        ...
                        <a href="#assinar" class="btn btn-primary rounded-pill">Assinar Agora!</a>
                    </div>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container mt-50 mb-50 pt-50 pb-50">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 align-items-center">
                    ...
                    <a href="#assinar" type="button" class="btn btn-outline-primary btn-block mt-30">Assinar TriboVIP</a>
                </div>
            </div>
        </div>
    </section>
